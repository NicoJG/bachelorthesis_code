...
with open("features_SS_classifier.json", "r") as file:
...
rule train_ss_classifier:
    ...
    resources:
        ...
        request_gpus=0
    shell: "python train_ss_classifier.py -t {threads} -n {params.model_name} &> {log}"
...
rule eval_ss_classifier:
    ...
    resources:
        ...
        request_memory=50*1024, # in MB
        request_gpus=0
    shell: "python model_investigation/eval_ss_classifier.py -t {threads} -n {params.model_name} &> {log}"
...
rule feature_importance_ss_classifier:
    ...
    resources:
        ...
        request_memory=50*1024, # in MB
        request_gpus=0
    shell: "python model_investigation/feature_importance_ss_classifier.py -t {threads} -n {params.model_name} &> {log}"
