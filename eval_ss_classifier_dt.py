...
tree.plot_tree(model, feature_names=feature_keys, class_names=["other","SS"], fontsize=10)
plt.savefig(output_dir/"00_plot_tree.pdf")
...
cut_linspace = np.linspace(0,1,100)
